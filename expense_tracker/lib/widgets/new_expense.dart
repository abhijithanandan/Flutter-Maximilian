...
class _NewExpenseState extends State<NewExpense> {
  ...
  void showPlatfromSepcificDialog() {
    if (Platform.isIOS) {
      showCupertinoDialog(
        context: context,
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (ctx, constrains) {
      // Check the available space for the widget
      log(constrains.minWidth.toString());
      log(constrains.maxWidth.toString());
      log(constrains.minHeight.toString());
      log(constrains.maxHeight.toString());
